...
import { getAllTags, getTagById, createTag, updateTag, deleteTag, deleteTags } from '../controllers/tag.controller.js';
import { authenticate } from '../middlewares/auth.middleware.js';
import authorize from '../middlewares/authorize.middleware.js';
import { validateTagById, validateTag, updateTagValidator, validateTagIds } from '../validators/tag.validator.js';
...
router.delete('/', authenticate, authorize('admin'), validateTagIds, validate, deleteTags);
